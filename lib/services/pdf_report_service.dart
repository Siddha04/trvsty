...
/// Generates the professional Trusty verification PDF report.
///
...
class PdfReportService {
  ...
  Future<Uint8List> build(VerificationRecord record) async {
    final doc = pw.Document(
      title: 'Trusty Verification Report ${record.shortId}',
  ...
  Future<void> share(VerificationRecord record) async {
    ...
    await Printing.sharePdf(
      bytes: bytes,
      filename: 'Trusty_Report_${record.shortId}.pdf',
    );
  }
  ...
  pw.Widget _footer(VerificationRecord record) => pw.Column(
        ...
        children: [
          ...
          pw.Text(
            'This report is generated by Trusty and complies with the DPDP Act, 2023. '
